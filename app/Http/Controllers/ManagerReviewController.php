...
use App\Repositories\ManagerReviewRepository;
...
class ManagerReviewController extends Controller
{
    ...
    private $managerReviewRepository;
    ...
    public function __construct(ManagerReviewRepository $managerReviewRepo, CustomFieldRepository $customFieldRepo, UserRepository $userRepo
        , RestaurantRepository $restaurantRepo)
    {
        parent::__construct();
        $this->managerReviewRepository = $managerReviewRepo;
 ...
 $reviews = $this->managerReviewRepository->where('manager_id',$user_id)->get();
  $reviews = json_decode( json_encode($reviews), true);
        return $restaurantReviewDataTable->render('manager_reviews.index')->with("reviews", $reviews);
    }
