...
use App\Repositories\ManagerCouponRepository;
...
class ManagerCouponController extends Controller
{
    ...
    private $managercouponRepository;
    ...
    public function __construct(ManagerCouponRepository $managercouponRepo, CustomFieldRepository $customFieldRepo, FoodRepository $foodRepo
        , RestaurantRepository $restaurantRepo
        , CategoryRepository $categoryRepo , DiscountableRepository $discountableRepository)
    {
        parent::__construct();
        $this->ManagerCouponRepository = $managercouponRepo;
 ...
 $coupons = $this->ManagerCouponRepository->where('manager',$user_id)->get();
  $coupons = json_decode( json_encode($coupons), true);
        return $couponDataTable->render('manager_coupons.index')->with("coupons", $coupons);
