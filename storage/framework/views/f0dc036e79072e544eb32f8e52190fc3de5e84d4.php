    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active"><?php echo e(trans('Order in Progress')); ?></li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      ...
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link" href="<?php echo e(url('orders/progress_orders')); ?>"><i class="fa fa-file-text-o mr-2"></i><?php echo e(trans('Orders in Progress')); ?></a>
        </li>
      </ul>
	  </div>
	  </div>
    ...
    <div class="card-body">
      ...
      <tbody>
          <?php $__currentLoopData = $progress_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <tr>
...
<?php echo $__env->make('layouts.appd', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\karri.li\public_html\restaurant\resources\views/orders/progress_orders.blade.php ENDPATH**/ ?>