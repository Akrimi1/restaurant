...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark"><?php echo e(trans('lang.term_plural')); ?><small class="ml-3 mr-3">|</small><small><?php echo e(trans('lang.term_desc')); ?></small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="<?php echo route('terms.index'); ?>"><?php echo e(trans('lang.term_plural')); ?></a>
          </li>
          <li class="breadcrumb-item active"><?php echo e(trans('lang.term_create')); ?></li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo route('terms.index'); ?>"><i class="fa fa-list mr-2"></i><?php echo e(trans('lang.term_table')); ?></a>
        </li>
        <?php endif; ?>
        <li class="nav-item">
          <a class="nav-link active" href="<?php echo url()->current(); ?>"><i class="fa fa-plus mr-2"></i><?php echo e(trans('lang.term_create')); ?></a>
        </li>
      </ul>
    </div>
    <div class="card-body">
      ...
      <div class="row">
        <?php echo $__env->make('terms.fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      </div>
      <?php echo Form::close(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\karri\resources\views/terms/create.blade.php ENDPATH**/ ?>