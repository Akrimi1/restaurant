...
<!-- Price Field -->
    <div class="form-group row ">
        ...
        <div class="col-9">
            <?php echo Form::number('price', null,  ['class' => 'form-control','placeholder'=>  trans("lang.food_price_placeholder"),'step'=>"any", 'min'=>"0"]); ?>
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            <?php echo Form::number('discount_price', null,  ['class' => 'form-control','placeholder'=>  trans("lang.food_discount_price_placeholder"),'step'=>"any", 'min'=>"0"]); ?>
...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            <?php echo Form::textarea('ingredients', null, ['class' => 'form-control','id' => 'editor2', 'placeholder'=>
    ...
    <!-- unit Field -->
    <div class="form-group row ">
        <?php echo Form::label('unit', trans("lang.food_unit"), ['class' => 'col-3 control-label text-right']); ?>

        <div class="col-9">
            <?php echo Form::text('unit', null,  ['class' => 'form-control','placeholder'=>  trans("lang.food_unit_placeholder")]); ?>

            <div class="form-text text-muted">
                <?php echo e(trans("lang.food_unit_help")); ?>
    ...
    <div class="form-group row ">
        <?php echo Form::label('package_items_count', trans("lang.food_package_items_count"), ['class' => 'col-3 control-label text-right']); ?>

        <div class="col-9">
            <?php echo Form::number('package_items_count', null,  ['class' => 'form-control','placeholder'=>  trans("lang.food_package_items_count_placeholder"),'step'=>"any", 'min'=>"0"]); ?>

            <div class="form-text text-muted">
                <?php echo e(trans("lang.food_package_items_count_help")); ?>
    ...
    <div class="form-group row ">
        <?php echo Form::label('deliverable', trans("lang.food_deliverable"),['class' => 'col-3 control-label text-right']); ?>
    ...
    <div class="form-group row ">
     ...
     <!-- cuisines Field -->
    <div class="form-group row ">
        <?php echo Form::label('cuisine', trans("Cuisines"),['class' => 'col-3 control-label text-right']); ?>

        <div class="col-9">
            <?php echo Form::select('cuisine', $cuisiness, null, ['class' => 'select2 form-control']); ?>

            <div class="form-text text-muted"><?php echo e(trans("lang.food_cuisines_help")); ?></div>
        </div>
    </div>
    
    
    <!--<div class="form-group row ">-->
    <!--   <label for="cuisine" class="col-sm-3 col-form-label">Cuisines</label>-->
    <!--    <div class="col-9">-->
...
<?php /**PATH /home/ka3r4ri/public_html/resources/views/foods/fields.blade.php ENDPATH**/ ?>