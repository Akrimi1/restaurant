                ...
                <div class="col-md-3">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-user mr-2"></i> <?php echo e(trans('About')); ?></h3>
                        </div>
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img src="<?php echo e(auth()->user()->getFirstMediaUrl('avatar','icon')); ?>" class="profile-user-img img-fluid rounded" alt="<?php echo e(auth()->user()->name); ?>">
                            </div>
                        ...
                        <div class="card-header">
                            <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
                                ...
                                <div class="ml-auto d-inline-flex">
                                    <li class="nav-item">
                                        <a class="nav-link pt-1" href="<?php echo route('restaurants.create'); ?>"><i class="fa fa-check-o"></i> <?php echo e(trans('lang.app_setting_become_restaurant_owner')); ?></a>
                                    </li>
                                </div>
                                <?php endif; ?>
                            </ul>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\karri.li\public_html\restaurant\resources\views/settings/users/profile.blade.php ENDPATH**/ ?>