        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group row col-6">
                    <?php echo Form::label('distance_unit', trans("lang.app_setting_distance_unit"),['class' => 'col-4 control-label text-right']); ?>

                    <div class="col-8">
                        <?php echo Form::select('distance_unit',
                        [
                        ...
                        <div class="form-text text-muted"><?php echo e(trans("lang.app_setting_distance_unit_help")); ?></div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.settings.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/karri/public_html/restaurant/resources/views/settings/mobile/globals.blade.php ENDPATH**/ ?>