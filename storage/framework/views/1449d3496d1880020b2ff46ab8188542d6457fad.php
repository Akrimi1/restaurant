...
<div class="content">
  ...
  <div class="card">
    ...
    <div class="card-body">
     <!--<form method="post" action="<?php echo e(action('ManagerController@save_manager')); ?>" accept-charset="UTF-8">-->
     <form method="post" action="<?php echo e(action('ManagerController@save_manager')); ?>" accept-charset="UTF-8">
     
         <?php echo csrf_field(); ?> 
      <div class="row">
        <?php echo $__env->make('managers.fields_managers', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      </div>
      <?php echo Form::close(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ka3r4ri/public_html/resources/views/managers/create.blade.php ENDPATH**/ ?>