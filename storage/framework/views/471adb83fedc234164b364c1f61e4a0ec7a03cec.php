...
<head>
    ...
    <title>Karri | Sign in to join Karri</title>
...
<div class="login-box">
    <div class="login-logo">
        <a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(url('/')); ?>/images/logo_default.png" alt="<?php echo e(setting('app_name')); ?>"></a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
...
</html><?php /**PATH C:\wamp64\www\karri.li\public_html\restaurant\resources\views/layouts/auth/default.blade.php ENDPATH**/ ?>