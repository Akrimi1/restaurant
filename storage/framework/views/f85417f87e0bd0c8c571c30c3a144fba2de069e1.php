...
<section class="content-header content-header<?php echo e(setting('fixed_header')); ?>">
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            <h1><?php echo e(trans('lang.payment')); ?></h1>
         </div>
         <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
               <li class="breadcrumb-item"><a href="#"><?php echo e(trans('lang.payment')); ?></a></li>
               <li class="breadcrumb-item active"><?php echo e(trans('lang.payment')); ?></li>
            </ol>
         </div>
      </div>
   </div>
   ...
   <div class="row">
      <div class="col-lg-2 col-6" >
         ...
         <div class="inner">
               ...
               <h3><?php echo e($admin_commission ."%"); ?></h3>
            </div>
      ...
      <div class="col-md-3 col-6" >
         ...
         <div class="inner">
               ...
               <h3><?php echo e($driver_commission ."%"); ?> </h3>
            </div>
            <div class="icon">
      ...
      <div class="col-lg-2 col-6" >
         ...
         <div class="inner">
               <p>Profit margin</p>
               <h3><?php echo e($profit_margin ."%"); ?></h3>
            </div>
            <div class="icon">
      ...
      <div class="col-lg-2 col-6" >
         ...
         <div class="small-box dash_box" id="colorsTiles5">
            <div class="inner">
               <p>Net losses</p>
               <?php if(setting('currency_right',false) != false): ?>
               <h3><?php echo e($netlosses); ?><?php echo e(setting('default_currency')); ?></h3>
               <?php else: ?>
               <h3><?php echo e(setting('default_currency')); ?><?php echo e($netlosses); ?></h3>
               <?php endif; ?>
            </div>
            <div class="icon">
               <i class="fa fa-group"></i>
 ...
 <script type="text/javascript">
          ...
          function drawChart() {
            ...
            var data = google.visualization.arrayToDataTable([
              ...
              ['On Delivery',<?php echo e($order_status_yearly['onway']); ?>],
                ['Delivered',<?php echo e($order_status_yearly['completed']); ?>],
   
              ['Canceled',<?php echo e($order_status_yearly['cancelled']); ?>]
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\karri\resources\views/payments/index.blade.php ENDPATH**/ ?>