...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            <?php echo Form::number('price', null,  ['class' => 'form-control','step'=>"any",'placeholder'=>  trans("lang.extra_price_placeholder")]); ?>
    ...
    <div class="form-group row ">
        <?php echo Form::label('extra_group_id', trans("lang.extra_extra_group_id"),['class' => 'col-3 control-label text-right']); ?>

        <div class="col-9">
            <?php echo Form::select('extra_group_id', $extraGroup, null, ['class' => 'select2 form-control']); ?>

            <div class="form-text text-muted"><?php echo e(trans("lang.extra_extra_group_id_help")); ?></div>
        </div>
    </div>
...
<?php /**PATH C:\wamp64\www\karri\resources\views/extras/fields.blade.php ENDPATH**/ ?>