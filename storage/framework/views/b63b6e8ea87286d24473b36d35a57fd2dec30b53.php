  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <!--<li class="nav-item">-->
        <!--  <a class="nav-link" href="<?php echo route('drivers.create'); ?>"><i class="fa fa-plus mr-2"></i><?php echo e(trans('create driver')); ?></a>-->
          <!--<a href="<?php echo e(route('drivers.create')); ?>">Create</a>-->
        <!--</li>-->
        <!--<?php endif; ?>-->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ka3r4ri/public_html/resources/views/drivers/index.blade.php ENDPATH**/ ?>