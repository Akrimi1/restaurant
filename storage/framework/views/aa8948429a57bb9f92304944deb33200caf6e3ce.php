...
<?php if($role_id == "3"): ?>
 <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('foodReviews*') ? 'active' : ''); ?>" href="<?php echo url('/managerReview'); ?>"><?php if($icons): ?>
                            <i class="nav-icon fa fa-comments"></i><?php endif; ?><p><?php echo e(trans('All Reviews')); ?></p></a>
                </li>
  <?php endif; ?>
  <?php if($role_id == "4"): ?>
 <li class="nav-item">
...
<?php endif; ?>
<?php /**PATH C:\wamp64\www\karri.li\public_html\restaurant\resources\views/layouts/menu.blade.php ENDPATH**/ ?>