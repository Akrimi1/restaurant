...
<div class="content">
  ...
  <div class="card">
    ...
    <div class="form-group row ">
        <?php echo Form::label('stores', trans("lang.store_id"),['class' => 'col-3 control-label text-right']); ?>

        <div class="col-9">
            <?php echo Form::select('stores_name', $stores_name ,null, ['class' => 'form-control']); ?>

            <div class="form-text text-muted"><?php echo e(trans("lang.store_id_help")); ?></div>
        </div>
    </div>
    <div class="form-group row ">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\karri\resources\views/contact/index.blade.php ENDPATH**/ ?>