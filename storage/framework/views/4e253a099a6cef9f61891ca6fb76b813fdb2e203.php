    ...
    <div class="card-body p-0">
        <ul class="nav nav-pills flex-column">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('currencies.index')): ?>
                <li class="nav-item">
                    <a href="<?php echo route('currencies.index'); ?>" class="nav-link <?php echo e(Request::is('settings/currencies*') ? 'selected' : ''); ?>" ><span class="nav-icon ml-1">₦</span> <?php echo e(trans('lang.currency_plural')); ?></a>
                </li>
            <?php endif; ?>
            ...
            <!--        <i class="fa fa-bell"></i> <?php echo e(trans('lang.firebase_app_setting_notifications')); ?>-->
            <!--    </a>-->
            <!--</li>-->
...
<div class="card <?php echo e(Request::is('settings/mobile*') ? '' : 'collapsed-card'); ?>">
    ...
    <div class="card-body p-0">
        <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
                <a href="<?php echo url('settings/mobile/color'); ?>" class="nav-link <?php echo e(Request::is('settings/mobile/color*') ? 'selected' : ''); ?>">
                    <i class="fa fa-inbox"></i> <?php echo e(trans('lang.app_colors')); ?>

                </a>
            </li>
              <li class="nav-item">
                <a href="<?php echo url('settings/mobile/content'); ?>" class="nav-link <?php echo e(Request::is('settings/mobile/content*') ? 'selected' : ''); ?>">
                    <i class="fa fa-inbox"></i> <?php echo e(trans('lang.app_contents')); ?>
...
<?php /**PATH /home/karri/public_html/restaurant/resources/views/layouts/settings/menu.blade.php ENDPATH**/ ?>