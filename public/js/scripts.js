...
function orderMonthly(){
var ctx = document.getElementById('orderMonthly').getContext('2d');
var myChart = new Chart(ctx, {
	...
	borderWidth: 1,
    data: [300, 700, 140, 250, 176]
  }, {
    label: "Undelivered",
    backgroundColor: "#f7c1c1",
	borderColor: "rgba(255, 99, 132, 1)",
	borderWidth: 1,
    data: [248, 345, 450, 200, 590]
  }, {
    label: "Completed",
    backgroundColor: "#bbe6bb",
	borderColor:"rgba(75, 192, 192, 1)",
	borderWidth: 1,
    data: [474, 329, 680, 782,500]
  }]
    },
    options: {
        scales: {
...
function orderYearly(){
var ctx = document.getElementById('orderYearly').getContext('2d');
var myChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'June'],
