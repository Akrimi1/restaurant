...
<!-- Price Field -->
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::textarea('description', null, ['class' => 'form-control', 'id' => 'editor','placeholder'=>
...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::textarea('ingredients', null, ['class' => 'form-control','id' => 'editor2', 'placeholder'=>
    ...
    <div class="form-group row ">
     ...
     <!-- cuisines Field -->
    <div class="form-group row ">
        {!! Form::label('cuisine', trans("Cuisines"),['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::select('cuisine', $cuisiness, null, ['class' => 'select2 form-control']) !!}
            <div class="form-text text-muted">{{ trans("lang.food_cuisines_help") }}</div>
        </div>
    </div>
