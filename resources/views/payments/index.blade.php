                            ...
                            @foreach($manager as $manager)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                         ...
                                         <a href="{{ url('/manager_details')}}" class="btn  text-center" style="color:#1921FA;"><i class="fa fa-eye"></i></a>
                            ...
                            @foreach($driver as $driver)
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                         ...
                                         <a href="{!! route('drivers.index') !!}" class="btn  text-center" style="color:#1921FA;"><i class="fa fa-eye"></i></a>
                                ...
                                <tr>
                                  ...
                                  <td>{!! $users->id !!}</td>
                                    ...
                                    <td class="text-center">
                                         ...
                                         <!--<a href="{{ url('/users_details')}}" class="btn  text-center" style="color:#1921FA;"><i class="fa fa-eye"></i></a>-->

                                         <a href="{{ url('/appCustomers')}}" class="btn  text-center" style="color:#1921FA;"><i class="fa fa-eye"></i></a>
