    ...
    <div class="card-body p-0">
        <ul class="nav nav-pills flex-column">
            ...
            @can('currencies.index')
                <li class="nav-item">
                    <a href="{!! route('currencies.index') !!}" class="nav-link {{ Request::is('settings/currencies*') ? 'selected' : '' }}" ><span class="nav-icon ml-1">₦</span> {{trans('lang.currency_plural')}}</a>
                </li>
            @endcan
            ...
            <!--        <i class="fa fa-bell"></i> {{trans('lang.firebase_app_setting_notifications')}}-->
            <!--    </a>-->
            <!--</li>-->
...
<div class="card {{ Request::is('settings/mobile*') ? '' : 'collapsed-card' }}">
    ...
    <div class="card-body p-0">
        <ul class="nav nav-pills flex-column">
            ...
            <li class="nav-item">
                <a href="{!! url('settings/mobile/color') !!}" class="nav-link {{  Request::is('settings/mobile/color*') ? 'selected' : '' }}">
                    <i class="fa fa-inbox"></i> {{trans('lang.app_colors')}}
                </a>
            </li>
              <li class="nav-item">
                <a href="{!! url('settings/mobile/content') !!}" class="nav-link {{  Request::is('settings/mobile/content*') ? 'selected' : '' }}">
                    <i class="fa fa-inbox"></i> {{trans('lang.app_contents')}}
                </a>
            </li>
