...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">{{trans('Edit About')}}<small class="ml-3 mr-3">|</small><small>{{trans('Edit About')}}</small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">{{trans('Edit About')}}</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
...
<div class="content">
  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="row">
           <?php $id = $value['id'];   ?>
      {{Form::open(array('url' => ['about/update', $id], 'method' => 'post', 'files' => true))}}
