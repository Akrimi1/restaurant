    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">{{trans('Live Orders')}}</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      ...
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link" href="{{ url('orders/live_orders') }}"><i class="fa fa-file-text-o mr-2"></i>{{trans('Live Orders')}}</a>
        </li>
      </ul>
	  </div>
	  </div>
    ...
    <div class="card-body">
      ...
      <tbody>
          @foreach($live_orders as $key => $data)
          <tr>
              <td>{{ $data['id'] }} </td>
              ...
              <a href="{{ url('/track/view', $data['id'] ) }}" class="btn btn-link"><i class="fa fa-map-marker"></i></a></td> 
            </tr>
         @endforeach
       </tbody>
      </table>
