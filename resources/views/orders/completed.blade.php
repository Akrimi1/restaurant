    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">{{trans('Completed Orders')}}</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      ...
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link" href="{{ url('orders/completed') }}"><i class="fa fa-file-text-o mr-2"></i>{{trans('Completed Orders')}}</a>
        </li>
      </ul>
	  </div>
	  </div>
    ...
    <div class="card-body">
      ...
      <tbody>
          @foreach($completed_orders as $key => $data)
          <tr>
              <td>{{ $data['id'] }} </td>
