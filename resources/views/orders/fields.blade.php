...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <div class="form-group row ">
        ...
        <div class="form-group row ">
        {!! Form::label('delivery_time', trans("Delivery time"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::number('delivery_time', null,  ['class' => 'form-control','step'=>"any",'placeholder'=>  trans("Delivery Time")]) !!}
            <div class="form-text text-muted">
                {{ trans("Delivery Time") }}
            </div>
        </div>
    ...
    <div class="form-group row ">
        ...
        <div class="col-9">
            {!! Form::textarea('hint', null, ['class' => 'form-control', 'id' => 'editor', 'placeholder'=>
