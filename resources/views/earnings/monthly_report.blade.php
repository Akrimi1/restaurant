...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">{{trans('lang.earning_plural')}}<small class="ml-3 mr-3">|</small><small>{{trans('Monthly Report')}}</small></h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
...
<div class="content">
  ...
  <div class="card">
    <div class="card-header">
        ...
        <li class="nav-item">
          <a class="nav-link" href=""><i class="fa fa-plus mr-2"></i>{{trans('Monthly Report')}}</a>
        </li>
        </ul>
    </div>
    <div class="card-body">
