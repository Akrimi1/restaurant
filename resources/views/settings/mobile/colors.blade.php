        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group row col-6">
                    {!! Form::label('main_color', trans("lang.app_walkthrough_bg_color"), ['class' => 'col-4 control-label text-right']) !!}
                    <div class="col-8">
                ...
                <div class="form-group row col-6">
                    {!! Form::label('main_dark_color', trans("lang.app_main_bg_color"), ['class' => 'col-4 control-label text-right']) !!}
                    <div class="col-8">
                        <div id="main-colorpicker" class="input-group colorpicker-component">
                ...
                <!-- second_color Field -->
                <div class="form-group row col-6">
                    {!! Form::label('second_color', trans("lang.app_title_color"), ['class' => 'col-4 control-label text-right']) !!}
                    <div class="col-8">
                        <div id="main-colorpicker" class="input-group colorpicker-component">
                        ...
                        <div class="form-text text-muted">
                            {{ trans("Insert the App Title Color") }}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row col-6">
                    {!! Form::label('second_dark_color', trans("lang.app_subtitle_color"), ['class' => 'col-4 control-label text-right']) !!}
                    <div class="col-8">
                        <div id="main-colorpicker" class="input-group colorpicker-component">
                        ...
                        <div class="form-text text-muted">
                            {{ trans("Insert the App SubTitle Color") }}
                        </div>
                    </div>
                </div>
                ...
                <!-- accent_color Field -->
                <div class="form-group row col-6">
                    {!! Form::label('accent_color', trans("lang.button_color"), ['class' => 'col-4 control-label text-right']) !!}
                    <div class="col-8">
                        <div id="main-colorpicker" class="input-group colorpicker-component">
                        ...
                        <div class="form-text text-muted">
                            {{ trans("Insert the App Main Button Color") }}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row col-6">
                    {!! Form::label('accent_dark_color', trans("lang.popupButton_color"), ['class' => 'col-4 control-label text-right']) !!}
                    <div class="col-8">
                        <div id="main-colorpicker" class="input-group colorpicker-component">
                        ...
                        <div class="form-text text-muted">
                            {{ trans("Insert the App Popup Button Color") }}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row col-6">
                    {!! Form::label('scaffold_dark_color', trans("lang.app_text_color"), ['class' => 'col-4 control-label text-right']) !!}
                    <div class="col-8">
                        <div id="main-colorpicker" class="input-group colorpicker-component">
                        ...
                        <div class="form-text text-muted">
                            {{ trans("Insert the App Main Text Color") }}
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group row col-6">
                    {!! Form::label('scaffold_color', trans("lang.app_accent_color"), ['class' => 'col-4 control-label text-right']) !!}
                    <div class="col-8">
                        <div id="main-colorpicker" class="input-group colorpicker-component">
