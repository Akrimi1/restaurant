  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <!--<li class="nav-item">-->
        <!--  <a class="nav-link" href="{{ url('Restaurants/add_vendors_details') }}"><i class="fa fa-plus mr-2"></i>{{trans('Create New category')}}</a>-->
      ...
      <tbody>
          ...
          <td>{{ $data['category'] }} </td>
            ...
            <div class='btn-group btn-group-sm'>
              ...
              <a data-toggle="tooltip" data-placement="bottom" title="{{trans('lang.category_edit')}}" href="{{ URL('super_admin/category/edit/'.$data['id'] )}}" class='btn btn-link'>
                <i class="fa fa-edit"></i>
              </a>

            <a data-toggle="tooltip" data-placement="bottom" title="{{trans('lang.view_details')}}" href="{{ URL('super_admin/category/delete/'.$data['id'] )}}" class='btn btn-link'>
