  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        <li class="nav-item">
          <a class="nav-link active" href="{{ url('/users_details') }}"><i class="fa fa-list mr-2"></i>{{trans('Users list')}}</a>
        </li>
        @can('categories.create')
        
        <!--<li class="nav-item">-->
        <!--  <a class="nav-link" href="{{ url('super_admin/add_users') }}"><i class="fa fa-plus mr-2"></i>{{trans('Create New manager')}}</a>-->
